...
class WESelectMenuListView: UIView,UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    ...
    var addDataList: Array<Any> = Array()
    ...
    override init(frame: CGRect) {
        ...
        if !self.isEqual(nil) {
            ...
            dataList = ["nihao","implemented","nihao","wohao","implemented","implemented","nihao","wohao"]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            ...
            cell.title.text = addDataList[indexPath.row] as? String
        } else {
            cell.title.text = dataList[indexPath.row] as? String
        }
        return cell
    }
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if indexPath.section == 0 {
            let with:CGFloat = getTexWidth(textStr: addDataList[indexPath.row] as! String, font: UIFont.systemFont(ofSize: 14), height: 30)+10
            return CGSize(width: with, height: 30)
        } else {
            return CGSize(width: getTexWidth(textStr: dataList[indexPath.row] as! String, font: UIFont.systemFont(ofSize: 14), height: 30)+10, height: 30)
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if indexPath.section == 0 {
            ...
            if addDataList.count < 8 {
                addDataList.append(dataList[indexPath.row])
