...
class ZXStoreManager: NSObject {
    // MARK: - 单利
    static let shared = ZXStoreManager()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "collectionFood", withExtension: "momd")!
