...
- (void)setupLayout
{
    self.itemSize = CGSizeMake(self.collectionView.bounds.size.width /2.5, self.collectionView.bounds.size.height);
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    CGFloat collectionViewHeight = self.collectionView.bounds.size.height/2.5;
