...
class WEDrawFoodView: UIView {
    ...
    func initView(array: [String], completion: @escaping (_ index:Int)->()) {
        draw = LotteryRouletteView(frame: CGRect.init(x: 0, y: 0, width: UIScreen.main.bounds.width-40, height: UIScreen.main.bounds.height/3.5*2 - 40), prizeArr: array , progress: { currentProgress, totalProgress in
